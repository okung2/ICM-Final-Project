...
function draw() {
  ...
  //   line(h, 50, 350, y2coord);
  // }
  //
  // line(25, 150, 75, 150);
  // for (let i = 25; i <= 75; i += 5) {
  //   line(i, 150, 50, y4coord);
  // }
  ...
  // line(25, 250, 75, 250);
  // for (let i = 25; i <= 75; i += 5) {
  //   line(i, 250, 50, y5coord);
  // }
  // line(125, 250, 175, 250);
  // for (let j = 125; j <= 175; j += 5) {
  //   line(j, 250, 150, y6coord);
  // }
  // line(225, 250, 275, 250);
  // for (let k = 225; k <= 275; k += 5) {
  //   line(k, 250, 250, y5coord);
  // }
  // line(325, 250, 375, 250);
  // for (let h = 325; h <= 375; h += 5) {
  //   line(h, 250, 350, y6coord);
  // }
  //
  // line(25, 350, 75, 350);
  // for (let i = 25; i <= 75; i += 5) {
  //   line(i, 350, 50, y8coord);
  // }
  // line(125, 350, 175, 350);
  // for (let j = 125; j <= 175; j += 5) {
  //   line(j, 350, 150, y7coord);
  // }
  // line(225, 350, 275, 350);
  // for (let k = 225; k <= 275; k += 5) {
  //   line(k, 350, 250, y8coord);
  // }
  // line(325, 350, 375, 350);
  // for (let h = 325; h <= 375; h += 5) {
  //   line(h, 350, 350, y7coord);
  // }
  //
